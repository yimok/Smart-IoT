    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="#">소2 <span class="sr-only">(current)</span></a></li>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="displayDiv" style ="display:none">
                                <img src="../resources/images/cow.jpg" width="300" height="300">
                            </div>
                            <div id="displayDiv2" style ="display:none">
                                <img src="../resources/images/medic.jpg" width="300" height="300">
                            </div>
                        </div>
                        </td>
